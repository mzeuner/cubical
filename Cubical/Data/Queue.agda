...
-- Two lemmas cobied from Cavallo's code
...
module Queues-on (A : Type ℓ) (Aset : isSet A) where
 ...
 Path-1-2 : 1List ≡ 2List
 Path-1-2 = SIP queue-structure queue-iso (SNS''→SNS''' Queue-is-SNS') 1List 2List .fst
